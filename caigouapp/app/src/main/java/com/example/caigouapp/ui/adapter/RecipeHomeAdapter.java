...
public class RecipeHomeAdapter extends RecyclerView.Adapter<RecipeHomeAdapter.ViewHolder>
{
    ...
    public RecipeHomeAdapter(List<MenusBean> menuList, Context context)
    {
    ...
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recipe_home_layout, parent, false);
        ViewHolder viewHolder = new ViewHolder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull RecipeHomeAdapter.ViewHolder holder, int position)
    {
